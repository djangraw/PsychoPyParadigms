...
# Declare stimulus and response parameters
    ...
    'stimDur': 1,             # time when stimulus is presented
    'ISI': 2,                 # time between when one page disappears and the next appears (in seconds)
...
# declare display parameters
    ...
    'fixCrossPos': [0,0],     # (x,y) pos of fixation cross displayed before each page (for gaze drift correction)
...
rtVec[:]=np.nan
# display images
for iStim in range(0,params['nTrials']): # +1 to inclue final page
    # display text
