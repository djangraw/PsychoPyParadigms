...
# Declare stimulus and response parameters
    ...
    'respKeys': ['g','b'],           # keys to be used for responses (mapped to y,n)
...
def RunTrial(iTrial):
    ...
    print('trial: iTrial = %d, isRemember = %d, delayDur = %.1f, ISI = %.1f, startString = %s, testString = %s, isTrueTrial = %d'%(iTrial+1,isRememberTrial,delayDur,ISI,startString,testString, isTrueTrial)) 
    logging.log(level=logging.EXP, msg='trial: iTrial = %d, isRemember = %d, delayDur = %.1f, ISI = %.1f, startString = %s, testString = %s, isTrueTrial = %d'%(iTrial+1,isRememberTrial,delayDur,ISI,startString,testString, isTrueTrial)) 
