...
expName = u'BuilderTest'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/jangrawdc/Documents/GitHub/PsychoPyParadigms/BuilderTest/BuilderTest.psyexp',
...
text_2 = visual.TextStim(win=win, name='text_2',
    text=u'Press 1 if the face is female.\nPress 2 if the face is male.',
    font=u'Arial',
...
image = visual.ImageStim(
    win=win, name='image',
    image=u'face1.jpg', mask=None,
    ori=0, pos=(0, 0), size=(0.5, 0.5),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=0.0)
text = visual.TextStim(win=win, name='text',
    text=u'Please enjoy this face.',
    font=u'Arial',
    pos=(0, 0), height=0.1, wrapWidth=None, ori=0, 
    color=u'white', colorSpace='rgb', opacity=1,
    depth=-1.0);
...
for thisTrial in trials:
    ...
    # keep track of which components have finished
    trialComponents = [image, text, cross, key_resp_2]
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if key_resp_2.status == STARTED:
            theseKeys = event.getKeys(keyList=['1', '2', 'left', 'right', 'space'])
