...
for thisTrial in trials:
    ...
    ns.send_event(key='fix+', timestamp=ms_localtime() + 500, label='fixation')
    ns.send_event(key=str(nstag), timestamp=ms_localtime() + 1000, label='dots')
